...
def get_required_skills():
    ...
    for job_desc in job_desc_list:
        ...
        # doc = nlp(description)
        # matches = matcher(doc)
        matches = process.extract(description, skills)
        allmatches = []
